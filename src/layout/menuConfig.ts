import { BookOpen, Briefcase, Building2, Calculator, CircleDollarSign, ClipboardCheck, Clock, FileMinus, FileText, Hammer, HardHat, Hash, Layers, Receipt, ShieldCheck, Store, Tags, User, UserCog, Users } from "lucide-react";
...
export const MENU_ENTRIES: MenuEntry[] = [
  ...
  },
  {
    ...
    icon: UserCog,
    route: "/employee-labor/list",
    module: Modules.EMPLOYEE_LABOR,
    permission: "can_read",
    section: "financials",
    priority: 49,
  },
  ...
  {
    id: "sub-cost-codes",
    label: "Sub Cost Codes",
    icon: Layers,
    route: "/sub-cost-code/list",
    module: Modules.COST_CODES,
    permission: "can_read",
    section: "reference",
    priority: 150,
